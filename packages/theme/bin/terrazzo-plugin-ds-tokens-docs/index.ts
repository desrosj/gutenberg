...
The token set is not a complete matrix of every property, target, tone, emphasis, and state combination. Omitted combinations are intentional when they do not map to a supported design-system role.
