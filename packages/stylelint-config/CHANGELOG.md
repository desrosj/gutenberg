...
-   Document why `plugin-wpds/no-token-fallback-values` remains opt-in for the shared Stylelint config ([#79768](https://github.com/WordPress/gutenberg/pull/79768)).
