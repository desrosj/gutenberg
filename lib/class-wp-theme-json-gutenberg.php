...
class WP_Theme_JSON_Gutenberg {
	 ...
	 *
	 * The column block uses `flex-basis` instead of `width` because it lives
	 * in a flex container. This post-processes the computed style declarations
	 * to ensure the correct CSS property is output.
	 *
	 * @since 6.9.0
	 *
