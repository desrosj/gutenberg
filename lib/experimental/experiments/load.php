		...
		array(
			...
			'items' => array(
				array(
					...
					'description' => __( 'Enables an Editing / Suggesting / Viewing mode switcher in the editor. In Suggesting mode, edits are captured as proposed changes (inline and structural) that the author can apply or reject, similar to suggesting changes in a document.', 'gutenberg' ),
				),
			),
		),
		array(
